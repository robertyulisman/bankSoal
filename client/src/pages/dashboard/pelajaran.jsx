...
export function Pelajaran() {
  ...
  const { data, isSuccess, isError } = useSelector((state) => state.pelajaran);
  ...
  const handleSubmitModal = () => {
    if (typeModal === "add") {
      dispatch(addPelajaran(form));
    } else {
      dispatch(editPelajaran(idSelected, form));
    }
  ...
  const handleDelete = (_id) => {
    swal({
      ...
      value == !null && dispatch(deletePelajaran(_id));
    });
  };
